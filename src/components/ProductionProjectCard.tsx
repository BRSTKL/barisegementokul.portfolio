  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden h-48">
        <img
          src={project.images[0] ? `${import.meta.env.BASE_URL}${project.images[0]}` : 'https://images.pexels.com/photos/3861969/pexels-photo-3861969.jpeg?auto=compress&cs=tinysrgb&w=800'} // Use first image or placeholder
          alt={project.title}
