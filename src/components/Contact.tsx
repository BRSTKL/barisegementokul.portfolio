      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto">
            ...
            Let's discuss how we can unlock insights from your data.
          </p>
        </motion.div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">barisegementokul@gmail.com</p>
            ...
            <div className="bg-slate-800 rounded-xl p-8 border border-slate-700">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 text-white px-8 py-4 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-2"
                >
                  {isSubmitting ? (
                    <>
        ...
        >
          <div className="bg-gradient-to-r from-blue-900/30 to-teal-900/30 rounded-xl p-8 border border-blue-800/30">
            <h3 className="text-2xl font-bold text-white mb-4">
              Ready to Transform Your Data?
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
              Whether you're looking to optimize business processes, understand customer behavior, 
              or build predictive models, I'm here to help you unlock the full potential of your data.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="border-2 border-slate-600 hover:border-blue-400 text-slate-300 hover:text-white px-8 py-3 rounded-lg font-semibold transition-colors"
              >
                View Portfolio
              </motion.button>
            </div>
